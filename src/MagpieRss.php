...
* File:        MagpieRss.php  - parse an RSS or Atom feed
...
require_once (MAGPIE_DIR . 'RssUtils.php');

/**
* Hybrid parser, and object, takes RSS as a string and returns a simple object.
*
* see: FetchRss.php for a simpler interface with integrated caching support
*
*/
class MagpieRss {
    var $parser;
